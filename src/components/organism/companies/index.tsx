    ...
    return (
        <section className="bg-background3 w-full flex flex-col p-16 relative shadow-xl">
            <div className="w-full flex flex-col sm:flex-row z-10">
                ...
                <div className="flex w-[50%] mt-16 justify-center relative">
                    ...
                    <div className="flex justify-center absolute z-20 w-[62%] h-[83.5%] bg-black mt-3 rounded-lg">
                        <Image src={webDesigner} alt="image web designer" className="w-[95%] rounded-md" />
                    </div>
                    <div className="absolute z-10 flex w-[85%] h-4 -bottom-4 bg-black opacity-35 rounded-lg mt-2 blur-sm"></div>
                </div>
            </div>
